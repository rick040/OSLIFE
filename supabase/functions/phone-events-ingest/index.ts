 ...
 * in the Schermtijd sheet.
 *
 * Per-app screen time (App Opened/Closed) is a separate concern handled by
 * screentime-app-ingest, not this function — see integrations/macrodroid/app-timer.md.
 *
