...
| Braindump media-worker (video/audio transcriptie, caption-loze YouTube) | `BRAINDUMP_WORKER_URL`, `WORKER_SECRET` (beide optioneel — zonder valt media terug op metadata-only) |
