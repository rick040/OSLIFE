 ...
 *
 * Reads data from your health export Google Sheet and upserts to oslife
 * via the `health-sheets-ingest` Supabase Edge Function (HEALTH_SYNC_URL).
 *
...
function installTrigger() {
  ...
  ScriptApp.getProjectTriggers()
    .filter(t => ["syncHealthToOslife", "syncHealthToRickOs"].includes(t.getHandlerFunction()))
