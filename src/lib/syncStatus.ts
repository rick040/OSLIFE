...
export const SYNC_SOURCES: SyncSource[] = [
  ...
  // ── Digitaal gedrag ──
  { key: 'screentime', label: 'Schermtijd', pipeline: 'App-timer (MacroDroid) → screentime-app-ingest', table: 'screentime', tsColumn: 'ingested_at', tsKind: 'ts', warnH: 48, downH: 24 * 5 },
